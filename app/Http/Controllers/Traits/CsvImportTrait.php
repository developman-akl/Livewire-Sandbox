...
/** 
 * How 2 Import CsvImportTrait to new project:
 * composer.json require:  "nuovo/spreadsheet-reader": "^0.5.11"
 * Add use CsvImportTrait; to the target Model
 * In the Trait row 100 need to mod the $routeName if needs any prefix like 'admin' or 'frontend'
 * resources\views\csvImport copy the two blades
 * resources\views\csvImportparseInput.blade.php change @extends('layouts.app') as needed
 * Copy the resources\lang\hu\global.php
 */
...
trait CsvImportTrait
{
    ...
    public function parseCsvImport(Request $request)
    {
        ...
        $routeName = strtolower(Str::plural(Str::kebab($modelName))) . '.processCsvImport';
